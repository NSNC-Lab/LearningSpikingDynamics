...
def init_params(args):
    ...
    Strf_alpha_lr_scale = np.zeros((1,len(args['simulation']['cell_targets'])))
    on_ron_lr_scale = np.zeros_like(Strf_alpha_lr_scale)
    off_ron_lr_scale = np.zeros_like(Strf_alpha_lr_scale)
    ...
    for count, k in enumerate(args['simulation']['cell_targets']):
        ...
        Strf_alpha_lr_scale[0,count] = Strf_alpha_mag
        ...
        on_ron_lr_scale[0,count] = on_ron_gSYN_mag
        ...
        off_ron_lr_scale[0,count] = off_ron_gSYN_mag
    ...
    lrs['Strf_alpha'] = Strf_alpha_lr_scale*args['simulation']['lr']
    lrs['Strf_gain'] = Strf_gain_mag*args['simulation']['lr']
    lrs['output_ad'] = output_ad_mag*args['simulation']['lr']
    lrs['on_ron_gSYN'] = on_ron_lr_scale*args['simulation']['lr']
    lrs['off_ron_gSYN'] = off_ron_lr_scale*args['simulation']['lr']
