...
def init_params(args):
    ...
    #Bring in the initialization from the mat file for testing the generatlizability
    loaded_object = loadmat('C:\\Users\\ipboy\\Documents\\GitHub\\LearningSpikingDynamics\\Archive\\Test_gen\\Data\\Param_init_test\\Test_gen_params')
    p_set = loaded_object['Parameter_set']
    ...
    params['Strf_alpha'] = np.tile(p_set[:,1],(args['simulation']['batch_size'],1))
    params['Strf_gain'] = np.tile(p_set[:,0],(args['simulation']['batch_size'],1))
    params['output_ad'] = np.tile(p_set[:,2],(args['simulation']['batch_size'],1))
    params['on_ron_gSYN'] = np.tile(p_set[:,7],(args['simulation']['batch_size'],1))
    params['off_ron_gSYN'] = np.tile(p_set[:,8],(args['simulation']['batch_size'],1))
    params['sonoff_ron_gSYN'] = np.tile(p_set[:,9],(args['simulation']['batch_size'],1))
    params['on_sonoff_gSYN'] = np.tile(p_set[:,10],(args['simulation']['batch_size'],1))
    params['off_sonoff_gSYN'] = np.tile(p_set[:,11],(args['simulation']['batch_size'],1))
    params['abs_ref'] = np.tile(p_set[:,3],(args['simulation']['batch_size'],1))
    params['rel_ref_a'] = np.tile(p_set[:,4],(args['simulation']['batch_size'],1))
    params['rel_ref_b'] = np.tile(p_set[:,5],(args['simulation']['batch_size'],1))
    params['rel_ref_c'] = np.tile(p_set[:,6],(args['simulation']['batch_size'],1))
