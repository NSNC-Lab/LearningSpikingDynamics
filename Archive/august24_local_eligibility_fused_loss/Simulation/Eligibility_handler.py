...
def update_eligibility(args, states, rate_object, timestep):
    ...
    states['neurons']['Learnable']['STRF_gain_accum'] = states['neurons']['Learnable']['STRF_gain_accum'] +  torch.sum((onset_static['psi']*(args['simulation']['dt']/1000)*args['simulation']['dt']*-onset_static['R']*onset_static["g_postIC"]*rate_object['onset_rate_gain_deriv'][timestep,:,None,:]*(onset_dynamic['V'][:,:,:,-1]-onset_static['E_exc'])/onset_static['tau']) +
                                                                                                                       (offset_static['psi']*(args['simulation']['dt']/1000)*args['simulation']['dt']*-offset_static['R']*offset_static["g_postIC"]*rate_object['offset_rate_gain_deriv'][timestep,:,None,:]*(offset_dynamic['V'][:,:,:,-1]-offset_static['E_exc'])/offset_static['tau']))
    states['neurons']['Learnable']['STRF_alpha_accum'] = states['neurons']['Learnable']['STRF_alpha_accum'] + torch.sum((onset_static['psi']*(args['simulation']['dt']/1000)*args['simulation']['dt']*-onset_static['R']*onset_static["g_postIC"]*rate_object['onset_rate_deriv'][timestep,:,None,:]*(onset_dynamic['V'][:,:,:,-1]-onset_static['E_exc'])/onset_static['tau']) +
                                                                                                                       (offset_static['psi']*(args['simulation']['dt']/1000)*args['simulation']['dt']*-offset_static['R']*offset_static["g_postIC"]*rate_object['offset_rate_deriv'][timestep,:,None,:]*(offset_dynamic['V'][:,:,:,-1]-offset_static['E_exc'])/offset_static['tau']))
