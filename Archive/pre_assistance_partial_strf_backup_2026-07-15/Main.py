...
def main():
    ...
    args = yaml.safe_load(open('C:\\Users\\ipboy\\Documents\\GitHub\\LearningSpikingDynamics\\Archive\\pre_assistance_partial_strf_backup_2026-07-15\\simulation_config.yaml', 'r'))
